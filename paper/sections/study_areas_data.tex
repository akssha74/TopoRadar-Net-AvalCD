...
\toprule
\shortstack{\textbf{Mountain}\\\textbf{System}} & \textbf{Event Name} & \textbf{Region / Country} & \shortstack{\textbf{Elevation}\\\textbf{Range (m)}} & \shortstack{\textbf{Grid Size}\\\textbf{(px)}} & \textbf{Polygons} & \shortstack{\textbf{Debris}\\\textbf{Area (px)}} \\
\midrule
