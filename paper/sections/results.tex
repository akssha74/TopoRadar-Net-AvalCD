...
\toprule
\multirow{2}{*}{\textbf{Method}} & \multirow{2}{*}{\textbf{Params}} & \multicolumn{3}{c}{\textbf{Troms{\o} (Scandinavian Arctic)}} & \multicolumn{2}{c}{\textbf{Pamirs (Tajikistan)}} & \textbf{Pooled Benchmark} \\
\cmidrule(lr){3-5} \cmidrule(lr){6-7} \cmidrule(lr){8-8}
 & & \textbf{Pixel F1} & \textbf{IoU (\%)} & \textbf{HR@0.3} & \textbf{Pixel F1} & \textbf{IoU (\%)} & \textbf{Macro F1 (\%)} \\
\midrule
...
Swin-UNet & 2.29M & $78.09 \pm 0.99$ & $64.07 \pm 1.33$ & $79.20 \pm 2.45$ & $48.73 \pm 2.74$ & $32.26 \pm 2.38$ & $63.41 \pm 1.03$ \\
\midrule
\textbf{TopoRadar-Net (Seed 42)} & 3.46M & $79.35$ & $65.76$ & $74.36$ & $51.23$ & $34.44$ & $65.29$ \\
\textbf{TopoRadar-Net (3-Seed)} & \textbf{3.46M} & $\mathbf{77.40 \pm 1.86}$ & $\mathbf{63.16 \pm 2.45}$ & $\mathbf{75.50 \pm 1.61}$ & $\mathbf{50.18 \pm 4.40}$ & $\mathbf{33.61 \pm 3.89}$ & $\mathbf{63.79 \pm 1.88}$ \\
\bottomrule
\end{tabular}
\end{table*}
...
\begin{tabular}{lcccccc}
\toprule
\multirow{2}{*}{\textbf{Ablation Variant}} & \multicolumn{3}{c}{\textbf{Troms{\o} (Scandinavian Arctic)}} & \multicolumn{2}{c}{\textbf{Pamirs (Central Asia)}} & \textbf{Pooled Benchmark} \\
\cmidrule(lr){2-4} \cmidrule(lr){5-6} \cmidrule(lr){7-7}
 & \textbf{Pixel F1 (\%)} & \textbf{IoU (\%)} & \textbf{Prec. (\%)} & \textbf{Pixel F1 (\%)} & \textbf{IoU (\%)} & \textbf{Macro F1 (\%)} \\
\midrule
...
\toprule
\multirow{2}{*}{\textbf{Region}} & \multirow{2}{*}{\textbf{Terrain Stratum}} & \multirow{2}{*}{\textbf{Area (px)}} & \multicolumn{2}{c}{\textbf{TopoRadar-Net (Ours)}} & \multicolumn{2}{c}{\textbf{Swin-UNet (Benchmark)}} & \multirow{2}{*}{\textbf{$\Delta$F1 (\%)}} \\
\cmidrule(lr){4-5} \cmidrule(lr){6-7}
 & & & \textbf{Pixel F1} & \textbf{Precision} & \textbf{Pixel F1} & \textbf{Precision} & \\
\midrule
\multirow{6}{*}{Troms{\o} (Arctic)} 
...
\cmidrule(lr){2-8}
 & Runout \& Valley ($< 25^\circ$) & 12,360 & $76.76\%$ & $70.68\%$ & $77.91\%$ & $76.23\%$ & $-1.15\%$ \\
...
\cmidrule(lr){2-8}
 & Runout \& Valley ($< 25^\circ$) & 6,501 & $45.97\%$ & $38.49\%$ & $38.22\%$ & $28.40\%$ & $+7.75\%$ \\
