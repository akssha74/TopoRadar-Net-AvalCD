...
\begin{itemize}
    ...
    \item \textbf{Impact of Geomorphic Loss:} In Troms{\o}, removing Geo-Loss reduces precision from $75.48\%$ to $72.50\%$ (a $-2.98\%$ precision drop) and lowers F1 to $76.70\%$, with paired cluster bootstrap establishing a $+3.16\%$ F1 gain ($p = 0.002$) attributable to the suppression of false positives on flat valley bottoms.
