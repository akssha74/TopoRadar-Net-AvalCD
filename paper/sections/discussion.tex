...
\begin{tabular}{lllcc}
\toprule
\textbf{Triage Level} & \textbf{Predicted Prob. ($p$)} & \textbf{Debris Area Range} & \textbf{Operational Response Action} & \textbf{Target Stakeholder} \\
\midrule
\textbf{Alert Level 1} & $p < 0.40$ & $< 0.1 \text{ ha}$ ($< 10 \text{ px}$) & Background surveillance; zero mobilization; $98.4\%$ valley clutter filtered & Warning Services (SLF, NVE) \\
\textbf{Alert Level 2} & $0.40 \le p < 0.70$ & $0.1\text{--}1.0 \text{ ha}$ ($10\text{--}100 \text{ px}$) & Automated tasking of local UAV patrols or high-resolution optical cueing & Regional Avalanche Forecasters \\
\textbf{Alert Level 3} & $p \ge 0.70$ & $\ge 1.0 \text{ ha}$ (EAWS D3/D4) & Immediate dispatch to highway authorities for transport corridor closure & Civil Protection / Police / Road Auth. \\
\midrule
\multicolumn{5}{l}{\textbf{Regional False-Alarm Footprint in Physical Units (Scene Area: Troms{\o} $98.6 \text{ km}^2$, Pamir $143.8 \text{ km}^2$)}} \\
\midrule
\textbf{Region} & \textbf{Method} & \textbf{Detected Debris (ha)} & \textbf{False-Alarm Area (ha / $\text{km}^2$)} & \textbf{False-Alarm Rate (ha / $\text{km}^2$)} \\
\midrule
\multirow{3}{*}{Scandinavian Arctic (Troms{\o})} & SiamUNet-diff & $218.33 \text{ ha}$ & $43.13 \text{ ha}$ ($0.43 \text{ km}^2$) & $0.44 \text{ ha} / \text{km}^2$ (Misses $121.39 \text{ ha}$) \\
 & Swin-UNet & $261.49 \text{ ha}$ & $68.34 \text{ ha}$ ($0.68 \text{ km}^2$) & $0.69 \text{ ha} / \text{km}^2$ \\
 & \textbf{TopoRadar-Net (Ours)} & $\mathbf{270.09 \text{ ha}}$ & $\mathbf{87.82 \text{ ha}}$ ($\mathbf{0.88 \text{ km}^2}$) & $\mathbf{0.89 \text{ ha} / \text{km}^2}$ (Detects $95.8\%$ D4) \\
\midrule
\multirow{3}{*}{Pamir Mountains (Pish)} & SiamUNet-conc & $163.76 \text{ ha}$ & $302.63 \text{ ha}$ ($3.03 \text{ km}^2$) & $2.10 \text{ ha} / \text{km}^2$ (Severe Clutter) \\
 & Swin-UNet & $150.43 \text{ ha}$ & $242.77 \text{ ha}$ ($2.43 \text{ km}^2$) & $1.69 \text{ ha} / \text{km}^2$ \\
 & \textbf{TopoRadar-Net (Ours)} & $\mathbf{130.25 \text{ ha}}$ & $\mathbf{169.89 \text{ ha}}$ ($\mathbf{1.70 \text{ km}^2}$) & $\mathbf{1.18 \text{ ha} / \text{km}^2}$ ($\mathbf{30.0\%}$ Clutter Reduction) \\
\bottomrule
\end{tabular}%
}
\end{table*}
