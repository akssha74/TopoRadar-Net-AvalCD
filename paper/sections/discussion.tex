...
\midrule
\multirow{3}{*}{Scandinavian Arctic (Troms{\o})} & SiamUNet-diff & $218.33 \text{ ha}$ & $43.13 \text{ ha}$ ($0.43 \text{ km}^2$) & $0.18 \text{ ha} / \text{km}^2$ (Misses $121.36 \text{ ha}$) \\
...
\begin{enumerate}
    \item \textbf{Physical-Unit Footprints:} In Pamir ($359.10~\text{km}^2$), TopoRadar-Net records $169.89$ ha of false alarms, $72.88$ ha ($30.0\%$) below Attention U-Net and $132.73$ ha ($43.9\%$) below SiamUNet-conc on the nominal grid; affine physical differences are $55.63$ and $101.33$ ha. In Troms{\o}, its false-alarm footprint ($87.82$ ha) exceeds Attention U-Net ($68.34$ ha), despite $95.8\%$ D4 completeness, so the trade-off is region dependent.
