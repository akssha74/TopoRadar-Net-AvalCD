...
Download the nine publication-bound model weights (`publication_checkpoints_3seeds.tar.gz`: TopoRadar-Net, Attention U-Net, and No-GeoLoss for seeds 42, 123, and 456) from [Release v1.0.13](https://github.com/akssha74/TopoRadar-Net-AvalCD/releases/tag/v1.0.13):
```bash
