...
| **Release v1.0.8 (Weights & Paper)** | [https://github.com/akssha74/TopoRadar-Net-AvalCD/releases/tag/v1.0.8](https://github.com/akssha74/TopoRadar-Net-AvalCD/releases/tag/v1.0.8) | **200 OK** | Immutable post-freeze package: `main.pdf` (13 pages), `main_anonymous.pdf`, byte-aligned submission-support sources/PDFs and comprehensive source ZIP, `publication_checkpoints_3seeds.tar.gz` (TopoRadar-Net + Attention U-Net, 3 seeds) |
...
* **Reviewer Model Parity (Latest Completed Independent State):**
  * **GLM-5.2 Round 26:** **28 / 30 (`accept`)** — 0 result/evidence blockers; two minor repository artifact notes are resolved in v1.0.8.
