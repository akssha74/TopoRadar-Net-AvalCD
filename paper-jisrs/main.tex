...
Valid-mask areas are 231.151 km$^2$ in Troms{\o} and 350.338 km$^2$ in Pish. TopoRadar-Net false-positive footprints are 87.82 ha (0.38 ha km$^{-2}$) and 169.89 ha (0.48 ha km$^{-2}$), respectively. Relative to the self-attention U-Net, this is a 30.0\% reduction in Pish but a 28.5\% increase in Troms{\o} (87.82 versus 68.34 ha). Validation-calibrated road-corridor alerts achieve $83.0\%$ precision and $62.5\%$ recall in Pish. The single road-intersecting reference avalanche in Troms{\o} is missed by every TopoRadar-Net seed. All cached complete-scene runs are below 5 s on Apple MPS hardware, but timing excludes upstream acquisition and human review.
